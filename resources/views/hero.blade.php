<section id="home" class="min-h-screen flex flex-col md:flex-row">
  ...
  <div style="background: #D3D3D3" class="hidden md:flex md:w-1/3 flex-col items-center justify-center text-center px-4">
        <h2 class="text-2xl font-bold mb-4 text-black px-5">Capturing Moments, Creating Memories</h2>
        <p class="text-lg text-black px-6">Professional photography for families, weddings, passports, and more. Plus, top-tier printing services for all your needs.</p>
  </div>
  <div class="hidden md:block md:w-1/3">
